...
<body>
    ...
    <div id="page-wrap">
        ...
        <section id="main">
            ...
            <article>
                <header>
                    <h2>Editare detalii hero section </h2>
                </header>
                    ...
                    if (isset($_GET['hero_id'])) {
                        ...
                        WHERE hero_id=".$id;
                            ...
                            if (!$result) {
                                ...
                                echo "<h2>Înapoi la <a href='hero.php'>tabel</h2>";
                            }
                        } else {
                            ...
                            ?>
                <form id="editHero" action="edithero.php?hero_id=<?=$id?>" method="post">
                ...
                <?php
                        ...
                        echo "<h2>Mergeți înapoi la <a href='hero.php'>tabel</h2>";
                    }
