            ...
            <article>
                ...
                <?php
                        ...
                        if (isset($_POST['submit'])) {
                            ...
                            $query = "INSERT INTO istorie (titlu, img, txt_1, txt_2) 
                            VALUES ( '$titlu', '$img', '$txt_1', '$txt_2')";
                            ...
                            if (!$result) {
                                ...
                                echo "<h2>Înapoi la <a href='ist.php'>istorie</a></h2>";
                            ...
                            ?>
                <form id="editIst" action="nouist.php" method="post">
                    <div>
                    ...
                    <div>
                        ...
                        <input type="text" name="txt_1" id="txt_1" value="">
                    </div>
                    <div>
                        <label for="txt_2">Text 2:</label>
                        <input type="text" name="txt_2" id="txt_2" value="">
                    </div>
