            ...
            <article>
                ...
                <?php
                        ...
                        if (isset($_POST['submit'])) {
                            ...
                            $query = "INSERT INTO beneficii (titlu,descriere, icon) 
                            VALUES ( '$titlu', '$descriere', '$icon')";
                            ...
                            if (!$result) {
                                ...
                                echo "<h2>Înapoi la <a href='benef.php'>beneficii</h2>";
                            ...
                            ?>
                <form id="editBenef" action="noubenef.php" method="post">
                    <div>
