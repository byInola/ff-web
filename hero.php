...
<body>
    ...
    <div id="page-wrap">
                ...
                <div class="col-1">
                    <nav id="sidebar" class="col sidebar">
                        ...
                        <ul style="list-style-type:none;" class="nav flex-column vertical-nav">
                            ...
                            <li class="nav-item"><a class="nav-link active" href="hero.php">Hero Section</a></li>
        ...
        if ($lista) {
            $query = "SELECT * FROM herosection order by hero_id ASC";
        }
        else {
            $query = "SELECT *
                FROM herosection
                WHERE herosection.hero_id=".$id;
        }
        ...
        <section id="main">
            <article>
                ...
                <table>
                    ...
                    <?php
                                echo "<td><a href='edithero.php?hero_id=" . $row['hero_id'] . " '><img src='img/edit.png' alt='edit icon' width='32px'></a></td>";
                                echo "<td><a href='hero.php?hero_id=" . $row['hero_id'] . "&action=delete'><img src='img/delete.png' alt='delete icon' width='32px'></a></td>";
                                echo "</tr>";
                                }
                            } else {
                ...
                <?php
                    ...
                    if ($action == "delete") {
                        ...
                        if (!$result) {
                            ...
                            echo "<meta http-equiv=\"refresh\" content=\"2; URL='hero.php'\" >";
