                ...
                <table>
                    ...
                    <?php
                            ...
                            while($row = mysqli_fetch_assoc($rezultat)) {
                                echo "<tr >";
                                echo "<td>" . $row["brand_id"] . "</a></td>";
                                ?>

                    <td><img id="img-t" src="img/<?=$row["brand_name"]?>" alt="img"></td>
                    <td><img id="img-t" src="img/<?=$row["brand_logo_1"]?>" alt="img"></td>
                    <td><img id="img-t" src="img/<?=$row["brand_logo_2"]?>" alt="img"></td>

                    <?php
                                echo "<td><a href='editbrand.php?brand_id=" . $row['brand_id'] . " '><img src='img/edit.png' alt='edit icon' width='32px'></a></td>";
                                echo "<td><a href='brand.php?brand_id=" . $row['brand_id'] . "&action=delete'><img src='img/delete.png' alt='delete icon' width='32px'></a></td>";
                                echo "</tr>";
                                }
                            } else {
