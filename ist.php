...
<body>
    ...
    <div id="page-wrap">
        ...
        if ($lista) {
            $query = "SELECT * FROM istorie ORDER BY h_id ASC";
        }
        else {
            $query = "SELECT *
                FROM istorie
        ...
        <section id="main">
            <article>
                ...
                <table>
                    ...
                    <td><?php echo $row["txt_1"]; ?></td>
                    <td><?php echo $row["txt_2"]; ?></td>

                    <?php
                                echo "<td><a href='editist.php?h_id=" . $row['h_id'] . " '><img src='img/edit.png' alt='edit icon' width='32px'></a></td>";
                                echo "<td><a href='ist.php?h_id=" . $row['h_id'] . "&action=delete'><img src='img/delete.png' alt='delete icon' width='32px'></a></td>";
                                echo "</tr>";
                                }
                            } else {
                ...
                <button id="b-nav" type="button"><a href="nouist.php">Add New</a></button>
                ...
                <?php
                    ...
                    if ($action == "delete") {
                        ...
                        $query = "DELETE FROM istorie WHERE h_id=".$id;
                        ...
                        if (!$result) {
                            ...
                            echo "<meta http-equiv=\"refresh\" content=\"2; URL='ist.php'\" >";
