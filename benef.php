...
<body>
    ...
    <div id="page-wrap">
        ...
        if ($lista) {
            $query = "SELECT * FROM beneficii order by b_id ASC";
        }
        else {
            $query = "SELECT *
                FROM beneficii
        ...
        <section id="main">
            <article>
                ...
                <table>
                    ...
                    <td><img id="img-t" src="img/<?php echo $row["icon"];?>" alt="img"></td>


                    <?php
                                echo "<td><a href='editbenef.php?b_id=" . $row['b_id'] . " '><img src='img/edit.png' alt='edit icon' width='32px'></a></td>";
                                echo "<td><a href='benef.php?b_id=" . $row['b_id'] . "&action=delete'><img src='img/delete.png' alt='delete icon' width='32px'></a></td>";
                                echo "</tr>";
                                }
                            } else {
                ...
                <button id="b-nav" type="button"><a href="noubenef.php">Add New</a></button>
                ...
                <?php
                    ...
                    if ($action == "delete") {
                        ...
                        $query = "DELETE from beneficii where b_id=".$id;
                        ...
                        if (!$result) {
                            ...
                            echo "<meta http-equiv=\"refresh\" content=\"2; URL='benef.php'\" >";
