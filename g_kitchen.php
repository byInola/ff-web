...
<body>
    ...
    <div id="page-wrap">
        ...
        if ($lista) {
            $query = "SELECT * FROM g_kitchen ORDER BY img ASC";

        }
        else {
            $query = "SELECT * FROM g_kitchen
                WHERE g_kitchen.img=".$id;
        }
            ...
            <article>
                ...
                <table>
                    ...
                    <?php
                                ...
                                echo "<td><a href='g_kitchen.php?img =" . $row['img'] . "&action=delete'><img src='img/delete.png' alt='delete icon' width='32px'></a></td>";
                                echo "</tr>";
                                }
                            } else {
                ...
                <button id="b-nav" type="button"><a href="noug_k.php">Add New</a></button>
                ...
                <?php
                    ...
                    if ($action == "delete") {
                        ...
                        $query = "DELETE FROM g_kitchen WHERE img=".$id;
                        $result=mysqli_query($conexiune, $query);
                        if (!$result) {
                            echo mysqli_error($conexiune);
                        } else {
                            echo "<h2>Ștergere efectuată!</h2>";
                            echo "<meta http-equiv=\"refresh\" content=\"2; URL='g_kitchen.php'\" >";
